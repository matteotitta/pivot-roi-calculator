...
export const inputSections: InputSection[] = [
  {
    ...
    fields: [
      ...
      { key: "annualSpendGrowthRate", label: "Annual spend growth rate", type: "percent", tooltip: "Expected YoY addressable spend growth", max: 30 },
      { key: "preferredSupplierSavings", label: "Preferred supplier savings", type: "percent", tooltip: "Avg savings from preferred supplier volume discounts", benchmark: "Aberdeen: 5-20%; Hackett: 10%", max: 30 },
      { key: "activeSuppliers", label: "Number of active suppliers", type: "number", tooltip: "Total active suppliers in your supplier master" },
      { key: "budgetOverspend", label: "Budget overspend (% of spend)", type: "percent", tooltip: "% of spend exceeding budget", benchmark: "Industry norm: 0-10%", max: 20 },
      { key: "earlyPaymentDiscountSpend", label: "Spend with early payment discount", type: "percent", tooltip: "% of spend with standing early payment discount terms", benchmark: "Typical: 5-10%", max: 50 },
      { key: "earlyPaymentDiscountRate", label: "Avg early payment discount rate", type: "percent", tooltip: "Typical: 2/10 Net 30 (2% discount if paid within 10 days)", max: 10, step: 0.5 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "expenseFraudErrorRate", label: "Expense report fraud / errors (% of spend)", type: "percent", tooltip: "% of T&E spend lost to errors or fraud", benchmark: "ACFE: ~5%", max: 10, step: 0.5 },
